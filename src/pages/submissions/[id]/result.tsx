...
export default function Results() {
  return (
    <>
      <Head>
        <title>Resultado do teste de Javascript | Rocketseat</title>
      </Head>
      ...
      <div className="mx-auto h-screen text-center flex flex-col items-stretch justify-center max-w-lg py-12 px-4">
        ...
        <h1 className="text-3xl font-bold">
          Fundamentos da web: <span className="text-emerald-500">Expert</span>
        </h1>

        <p className="text-md text-zinc-400 mt-2">
          Seu nível está acima de <span className="font-bold">76%</span> de outros usuários
        </p>
        ...
        <div className="relative my-6 mx-12">
          ...
          <div className="relative flex justify-center">
            <span className="px-4 bg-zinc-900 text-sm text-zinc-500">Compartilhe</span>
          </div>
        </div>
